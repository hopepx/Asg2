...
function checkForMatch(){
    if(firstCard.dataset.name === secondCard.dataset.name){
        ...
        // If the first match has not been found yet, lock all cards and set the flag to true
        if (!firstMatchFound) {
          lockAllCards();
...
function displayMatchedCards() {
  firstCard.style.transform = "scale(2.5)";
  secondCard.style.transform = "scale(2.5)";
}
